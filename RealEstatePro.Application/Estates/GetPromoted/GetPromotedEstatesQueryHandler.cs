...
public class GetPromotedEstatesQueryHandler
    ...
    : IRequestHandler<GetPromotedEstatesQuery, Result<List<EstateDto>>>
{
    public async Task<Result<List<EstateDto>>> Handle(GetPromotedEstatesQuery request, CancellationToken cancellationToken)
    {
